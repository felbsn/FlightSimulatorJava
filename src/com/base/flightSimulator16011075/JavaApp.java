...
public class JavaApp {
  ...
  public static void main(String[] args) throws InterruptedException {
      ...
      // setting cancel ratio 0-1 ,  0 means no cancel operation
      Simulator.setCancelRatio(0.2);

     
      // i set calender time to 8.00 am
     ...
     // creating control towers / cities vs 
    ...
    AirTrafficControlTower atc2 = new AirTrafficControlTower("almanya" , flightManager, new WorldCoordinates(-0.2, -0.6));
    AirTrafficControlTower atc3 = new AirTrafficControlTower("türkiye" , flightManager, new WorldCoordinates(-0.05, -0.5));
    AirTrafficControlTower atc4 = new AirTrafficControlTower("amerika" , flightManager, new WorldCoordinates(-0.6, -0.5));
    AirTrafficControlTower atc5 = new AirTrafficControlTower("çin" , flightManager, new WorldCoordinates(0.4, -0.4));
    AirTrafficControlTower atc6 = new AirTrafficControlTower("kanada" , flightManager, new WorldCoordinates(-0.7, -0.4));
    
    // creating some inbuild rotines 
     ...
     FlightRoutine ro5 = new FlightRoutine("firma5" , flightManager , 22 , 45 , atc5 , atc4);
     FlightRoutine ro6 = new FlightRoutine("firma6" , flightManager , 7 , 00 , atc5 , atc3);
     FlightRoutine ro7 = new FlightRoutine("firma7" , flightManager , 14 , 30 , atc5 , atc0);
     FlightRoutine ro8 = new FlightRoutine("firma8" , flightManager , 18 , 30 , atc5 , atc4);
     FlightRoutine ro9 = new FlightRoutine("firma9" , flightManager , 17 , 15 , atc3 , atc4);
    		 
     
     
     // add all new units to flight manager
     ...
     flightManager.addRoutine(ro6);
     flightManager.addRoutine(ro7);
     flightManager.addRoutine(ro8);
     flightManager.addRoutine(ro9);
     
    // starting flight manager routine handler
     flightManager.StartCheckingService();
     

     // defined routines panel
     JPanel panelRoutines = new JPanel();
     
     
    // continues with gui elements...
     ...
     frame.add(bannerLabel);
      ...
      // world map picture , not necessary
      JLabel picLabel;
      try {
        Image img = ImageIO.read(new File("world.gif"));

         picLabel = new JLabel(new ImageIcon(img.getScaledInstance(mapWidth, mapHeight,  java.awt.Image.SCALE_SMOOTH)));
         picLabel.setBounds(mapX, mapY, mapWidth, mapHeight);
         frame.add(picLabel);
