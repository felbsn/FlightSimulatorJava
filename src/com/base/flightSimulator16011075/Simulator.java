...
public class Simulator {
    ...
    public static void setCancelRatio(double ratio)
    {
    	instance.cancelRatio = ratio;
    }
    ...
    public static boolean RandCancel()
    {
    	return Distribution.GetCancelRatio(instance.rnd,instance.cancelRatio) ;
